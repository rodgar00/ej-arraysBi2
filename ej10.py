...
print(f"Este es el valor de la pieza 1: {valorTotalPieza1}")
valorTotalPieza2 = sum(tablaM3N2[fila][1] for fila in range(almacenes))
print(f"Este es el valor de la pieza 2: {valorTotalPieza2}")
valorTotalPieza3 = sum(tablaM3N2[fila][2] for fila in range(almacenes))
print(f"Este es el valor de la pieza 3: {valorTotalPieza3}")
